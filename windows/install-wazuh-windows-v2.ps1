...
.PARAMETER EnrollmentPassword
    Optional enrollment password if set on the Wazuh manager.

.PARAMETER SkipDownload
    Skip downloading installers if they already exist in the temp folder.

.EXAMPLE
    # Run with defaults (hostname as agent name)
...
.EXAMPLE
    # With enrollment password
    .\Install-WazuhAgent.ps1 -EnrollmentPassword "MySecret123"
#>
...
# =============================================================================
# STEP 3 — Write stunnel client config
# =============================================================================
